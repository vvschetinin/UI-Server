        ...
        <div class="container--middle">
          <div class="row element-animation-up">
            <div class="col-100">
              <div class="hero-inner">
                <h3 class="sectorname">Castom CMS</h3>
                <h1 class="h1-inner">Верстка по дизайну для CMS<span>Адаптивность и готовность к интеграции</span></h1>
              </div>
              <article>
                <p>
          ...
          <div class="row mt-3">
            <div class="col-100">
              <article>
                <p>
                  <span class="color-white font-middle">Готовы оживить дизайн своего сайта?</span> Получите адаптивную,
                  валидную верстку, готовую для CMS, которая
                  усилит ваш сайт и привлечет клиентов! Я создам решение, идеально подходящее вашему бизнесу, с
                  современной версткой и базовым SEO. Свяжитесь для консультации,
                  и мы начнем превращать ваш дизайн в функциональный сайт уже сегодня!
                </p>
              </article>
              <!-- Блок кнопок -->
