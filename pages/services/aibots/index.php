    ...
    <main class="site-content">
      <section class="section-inner bg-dark">
        <div class="container--middle">
          <div class="row element-animation-up">
            <div class="col-100">
              <div class="hero-inner">
                <h3 class="sectorname">AI Chathbots</h3>
                <h1 class="h1-inner deco-line mb-0">Общение 24/7<span>Чат-боты для автоматизация общения</span></h1>
              </div>
              <article>
                <p>
          ...
          <div class="row mt-2">
            <div class="col-100 col-xl-80 pl-0 pl-3--sm">
              <article class="service-step">
                ...
                <p>
                  AI чат-боты обеспечивают общение с клиентами 24/7, мгновенно отвечая на вопросы в любое время. Это
                  повышает удовлетворённость клиентов, снижает
                  нагрузку на вашу команду и позволяет бизнесу работать без перерывов, укрепляя лояльность и доверие.
                </p>
              </article>
              <article class="service-step mt-15">
                ...
                <p>
                  ...
                  сокращает затраты на персонал и ускоряет процессы, повышая эффективность бизнеса.
                </p>
              </article>
              <article class="service-step mt-15">
                <h3 class="h3-title lh-1 mb-05">Персонализация общения</h3>
                <p>
                  Настраиваю чат-боты под стиль вашего бренда, чтобы они отвечали естественно и профессионально.
                  Учитываю особенности вашей аудитории, создавая
                  индивидуальный опыт, который усиливает доверие и делает каждое взаимодействие запоминающимся.
                </p>
              </article>
              <article class="service-step mt-15">
                <h3 class="h3-title lh-1 mb-05">Рост конверсий</h3>
                <p>
                  Разрабатываю AI-чат-боты, которые направляют клиентов к покупке, предлагая рекомендации и отвечая на
                  возражения. Это увеличивает конверсии в продажах
                  и заявках, помогая бизнесу привлекать больше клиентов и достигать целей.
                </p>
              </article>
            </div>
          </div>
          ...
          <div class="row mt-3 element-animation-up">
            <div class="col-100">
              <article class="">
                ...
                <p>
                  AI-чат-боты — идеальное решение для тех, кто стремится к автоматизации и качественному сервису.
                  Интернет-магазины? Настрою ботов для ускорения
                  обработки заказов и роста конверсий. Службы поддержки? Обеспечу мгновенные ответы, снижая нагрузку на
                  команду. Рестораны или салоны красоты?
                  Автоматизирую бронирование и консультации. Малый бизнес и стартапы получат доступный способ быть на
                  связи 24/7, укрепляя лояльность клиентов без
                  больших затрат. Если хотите сократить рутину, улучшить клиентский опыт и повысить эффективность, мои
                  AI-чат-боты станут надёжным помощником. Адаптирую
                  бота под ваши задачи, чтобы он работал на ваш успех. Начните уже сегодня и сделайте общение с
                  клиентами проще и результативнее!
                </p>
              </article>
            </div>
          </div>
          ...
          <div class="row mt-3 element-animation-up">
            <div class="col-100">
              <h2 class="h2-title deco-line">Что входит в услугу AI чат-ботов</h2>
            </div>
            <div class="col-100 col-xl-80 pl-0 pl-3--sm">
              <article class="service-step">
              ...
              <article class="service-step mt-15">
                <h3 class="h3-title lh-1 mb-05">Персонализированные рекомендации</h3>
                <p>
                  Программирую чат-боты для анализа запросов и предложения индивидуальных решений или товаров. Это
                  повышает вовлечённость, увеличивает продажи и создаёт
                  уникальный клиентский опыт для вашего бизнеса.
                </p>
              </article>
            </div>
          </div>
          ...
          <div class="row mt-3">
            <div class="col-100">
              <article>
                <p>
                  <span class="color-white font-middle">Готовы автоматизировать общение?</span> Запустите AI-чат-бота и
                  сделайте ваш бизнес доступным 24/7! Получите
                  умного помощника для консультаций, заказов и роста лояльности. Свяжитесь со мной для консультации —
                  ваш успех в одном клике!
                </p>
              </article>
              <!-- Блок кнопок -->
            ...
            <a class="footer-logo svg" href="/">
              <svg class="logo-svg" viewBox="0 0 230 161" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                  ...
                  fill="white" />
                <defs>
                  <lineargradient x1="6.04283" y1="84.1438" x2="28.5536" y2="118.823" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#0054E8" stop-opacity="0.8" />
                    <stop offset="1" stop-color="#0054E8" stop-opacity="0" />
                  </lineargradient>
                  <lineargradient x1="29.5338" y1="118.018" x2="69.611" y2="128.277" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#362196" stop-opacity="0.8" />
                    <stop offset="1" stop-color="#362196" stop-opacity="0" />
                  </lineargradient>
                  <lineargradient x1="8.84954" y1="38.8607" x2="5.91492" y2="83.5082" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#1CD4BD" stop-opacity="0.8" />
                    <stop offset="1" stop-color="#1CD4BD" stop-opacity="0" />
                  </lineargradient>
                  <lineargradient x1="39.4887" y1="9.39708" x2="11.4865" y2="37.6217" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#009E00" stop-opacity="0.8" />
                    <stop offset="1" stop-color="#009E00" stop-opacity="0" />
                  </lineargradient>
                  <lineargradient x1="87.7165" y1="7.38467" x2="41.6552" y2="7.38467" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#E84F1C" stop-opacity="0.8" />
                    <stop offset="1" stop-color="#E84F1C" stop-opacity="0" />
                  </lineargradient>
                  <lineargradient x1="119.886" y1="30.8421" x2="89.3295" y2="7.90342" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#DE0030" stop-opacity="0.8" />
                    <stop offset="1" stop-color="#DE0030" stop-opacity="0" />
                  </lineargradient>
                  <lineargradient x1="130.778" y1="66.2393" x2="119.82" y2="31.3772" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#7D051F" stop-opacity="0.8" />
                    <stop offset="1" stop-color="#7D051F" stop-opacity="0" />
                  </lineargradient>
                </defs>
