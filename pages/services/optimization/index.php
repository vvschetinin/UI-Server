    ...
    <main class="site-content">
      ...
      <section class="section-inner bg-dark">
        <div class="container--middle">
          <div class="row element-animation-up">
            <div class="col-100">
              <div class="hero-inner">
                <h3 class="sectorname">Optimization</h3>
                <h1 class="h1-inner">Технический апгрейд вашего сайта<span>Скорость, надёжность и конверсии</span></h1>
              </div>
              <article>
                <p>
                  ...
                  загрузке или ошибках кода — я создам решение, которое усилит ваш бизнес. Свяжитесь, чтобы обсудить,
                  как вывести ваш сайт на новый уровень!
                </p>
              </article>
            </div>
          </div>
          ...
          <div class="row mt-2">
            <div class="col-100 col-xl-80 pl-0 pl-3--sm">
              <article class="service-step">
                <h3 class="h3-title lh-1 mb-05">Мобильная адаптация</h3>
                <p>
                  Сайт становится удобным на смартфонах и планшетах, привлекая больше мобильного трафика. Адаптивный
                  дизайн повышает позиции в Google и улучшает
                  пользовательский опыт, увеличивая конверсии.
                </p>
              </article>
              <article class="service-step mt-15">
                <h3 class="h3-title lh-1 mb-05">Высокая скорость</h3>
                <p>
              ...
              <article class="service-step mt-15">
                <h3 class="h3-title lh-1 mb-05">Надёжность кода</h3>
                <p>
            ...
            <div class="col-100">
              <article class="">
                ...
                <p>
                  ...
                  для стабильности. Если хотите больше трафика, конверсий и уверенности в сайте, я настрою технические
                  решения под ваши задачи. Свяжитесь, чтобы начать!
                </p>
              </article>
            </div>
          </div>
          ...
          <div class="row mt-3 element-animation-up">
            <div class="col-100">
              <h2 class="h2-title deco-line">Что входит в технические услуги</h2>
            </div>
            <div class="col-100 col-xl-80 pl-0 pl-3--sm">
              <article class="service-step">
                <h3 class="h3-title lh-1 mb-05">Мобильная адаптация сайта</h3>
                <p>
                  Разрабатываю адаптивный дизайн, тестирую на всех устройствах, чтобы сайт был удобным на смартфонах и
                  планшетах. Это увеличивает мобильный трафик на
                  30%+, улучшает UX и повышает позиции в Google.
                </p>
              </article>
              <article class="service-step mt-15">
                <h3 class="h3-title lh-1 mb-05">Оптимизация Google PageSpeed</h3>
                <p>Оптимизирую изображения, код и сервер, чтобы достичь PageSpeed 90+. Быстрая загрузка снижает отказы,
                  улучшает SEO и повышает конверсии на 20%.</p>
              </article>
              <article class="service-step mt-15">
              ...
              <article class="service-step mt-15">
                <h3 class="h3-title lh-1 mb-05">Настройка аналитики и трекинга</h3>
                <p>
              ...
              <article class="service-step mt-15">
                ...
                <p>Обновляю CMS, плагины, создаю бэкапы, устраняю ошибки. Это гарантирует безопасность, стабильность
                  сайта и экономит ваше время для бизнеса.</p>
              </article>
            </div>
          </div>
          <!-- Призыв к действию -->
          <div class="row mt-3">
            <div class="col-100">
              <article>
                <p>
                  <span class="color-white font-middle">Готовы улучшить сайт?</span> Увеличьте трафик, конверсии и
                  надёжность с моими техническими решениями! От
                  мобильной адаптации до аналитики — я создам апгрейд, который выведет ваш бизнес на новый уровень.
                  Свяжитесь для консультации и начните усиливать сайт
                  уже сегодня!
                </p>
              </article>
              <!-- Блок кнопок -->
