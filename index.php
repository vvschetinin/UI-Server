      ...
      <section class="hero hero--large bg-hero">
        ...
        <div class="hero-container">
          <div class="hero-content">
            ...
            <h1 class="hero-title">AI-инструменты для бизнеса<span>Чат-боты, Контент-маркетинг и многое другое</span>
            </h1>
            <div class="hero-text">
              <p>Помогаю малому бизнесу экономить время и привлекать клиентов с помощью AI-ассистентов, качественного
        ...
        <i class="hero-logo-circle svg">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 573.7 676.8"
            ...
            aria-label="Логотип Владлена Щетинина - AI для бизнеса">
